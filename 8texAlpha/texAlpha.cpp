...
bool Setup()
{
	...
	D3DXCreateTextureFromFile(
		Device,
		_T("cratewalpha.dds"),     // 这个文件是alpha通道文件
		&CrateTex);
	...
	// use alpha channel in texture for alpha 从纹理的alpha通道中获得alpha分量
	Device->SetTextureStageState(0, D3DTSS_ALPHAARG1, D3DTA_TEXTURE);   // 从纹理的alpha通道中获得alpha分量
	Device->SetTextureStageState(0, D3DTSS_ALPHAOP, D3DTOP_SELECTARG1); // 设置alpha操作参数1
