...
bool Setup()
{
	...
	if( toonErrorBuffer )
	{
		::MessageBoxA(0, (char*)toonErrorBuffer->GetBufferPointer(), 0, 0);
	...
	{
		::MessageBoxA(0, (char*)outlineErrorBuffer->GetBufferPointer(), 0, 0);
	...
	D3DXCreateTextureFromFile(Device, _T("toonshade.bmp"), &ShadeTex);
